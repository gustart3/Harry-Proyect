...
function generarCarta() {
    ...
    cartaImagenElement.style.top = '0';
    cartaImagenElement.style.left = '-150px';
    cartaImagenElement.style.width = '100%';
    cartaImagenElement.style.height = 'auto';
    ...
    firmaElement.style.bottom = '15vh';
    firmaElement.style.left = '1vh';
    firmaElement.style.fontSize = '20px';

    const membreteElement = document.getElementById('carta-membrete')
    membreteElement.style.position = 'relative';
    membreteElement.style.top = '40%';
    membreteElement.style.right = '90%';
    ...
    cartaContainer.style.width ="100vw";
    cartaContainer.style.minWidth ="10%";
    cartaContainer.style.gridColumn = "2/ span 2";
  

    const textoContainer = document.getElementById("texto1");
    textoContainer.style.gridRow = "2";
    textoContainer.style.gridColumn= "1/3";
